var ann = function(options) {
    ...
    */
    function createNetwork(network) {
        var recreatedPerceptrons = [];
        for(var i = 0; i < network.perceptrons.length; i++) {
            recreatedPerceptrons.push(new ann.perceptron().createPerceptron(network.perceptrons[i]));
        }
    ...
    */
    function getNetwork() {
        var perceptronRepresentation = [];
        for(var i = 0; i < perceptrons.length; i++) {
            perceptronRepresentation.push(perceptrons[i].getPerceptron());
        }
        return {
            options: options,
            layers: layers,
